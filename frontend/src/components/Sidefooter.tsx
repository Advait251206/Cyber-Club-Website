// Helper components for the social icons to keep the main component clean
const InstagramIcon = () => (
    ...
    return (
        <div className="space-y-4">
            <div className="flex items-center space-x-3">
                <img src="/cyber.png" alt="Cyber Club Logo" width={50} />
                <div>
                    <p className="text-2xl font-bold text-green-300">Cyber Club</p>
                    <sub className="text-gray-400">Ramdeobaba University</sub>
                </div>
            </div>
            <p className="max-w-md">
                Empowering the next generation of cybersecurity professionals through hands-on learning, real-world challenges, and industry connections.
            </p>

            <div className="flex space-x-4 pt-2">
                <a href="https://www.instagram.com/rbu_cyber_club/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
                    <InstagramIcon />
                </a>
                <a href="https://www.linkedin.com/company/rbucyberclub/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
                     <LinkedInIcon />
                </a>
